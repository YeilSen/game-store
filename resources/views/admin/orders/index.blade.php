        ...
        <div class="col-md-12">
            ...
            <div class="text-center mb-5">
                ...
                <p class="text-light" style="opacity: 0.8; font-size: 1rem;">
                    Gestiona y visualiza todas las compras realizadas en la plataforma
                </p>
            </div>
                ...
                ">
                    ...
                    ">
                        <h5 class="mb-0 gaming-font" style="color: #22d3ee;">
                            <i class="bi bi-clock-history me-2"></i> LISTADO DE PEDIDOS ({{ $orders->total() }})
                        </h5>
                    </div>
                            ...
                            <table class="table mb-0" style="background: transparent !important;">
                                <thead>
                                    <tr style="background: rgba(34, 211, 238, 0.05); border-bottom: 2px solid rgba(99, 102, 241, 0.3);">
                                        ...
                                        <th style="color: #ffffff !important; padding: 15px;">USUARIO</th>
                                ...
                                <tbody>
                                    @foreach($orders as $order)
                                        ...
                                        <tr style="border-bottom: 1px solid rgba(99, 102, 241, 0.1); cursor: pointer;" onclick="toggleDetail('orderDetail{{ $order->id }}')">
                                            ...
                                            <td style="padding: 15px; vertical-align: middle;">
                                                <div class="d-flex align-items-center">
                                                    <i class="bi bi-person-circle me-2" style="color: #a855f7;"></i>
                                                    <span style="color: #e2e8f0;">{{ $order->user->name }}</span>
                                                </div>
                                        ...
                                        <tr class="order-detail-row" id="orderDetail{{ $order->id }}" style="display: none;">
                                            <td colspan="6" style="padding: 0; background: rgba(15, 23, 42, 0.5);">
                                                <div class="p-4">
                                                    <div class="row mb-4">
                                                        <div class="col-md-4">
                                                        ...
                                                        <div class="col-md-4">
                                                            <p class="mb-1" style="color: #94a3b8;">USUARIO</p>
                                                            <p style="color: #e2e8f0;">{{ $order->user->name }}</p>
