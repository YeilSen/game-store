        ...
        <div class="col-md-10">
            ...
            <div class="text-center mb-5">
                ...
                <p class="text-light" style="opacity: 0.8; font-size: 1rem;">
                    Consulta todas tus compras realizadas en Rayonic
                </p>
            </div>

            {{-- Botón de volver --}}
            <div class="mb-4">
                <a href="{{ route('profile.edit') }}" class="btn" style="
                ...
                ">
                    <div class="card-body">
                        ...
                        <p class="text-light mb-4" style="opacity: 0.7;">
                            ¡Realiza tu primera compra en nuestro catálogo!
                        </p>
                ...
                ">
                    ...
                    ">
                        <h5 class="mb-0 gaming-font" style="color: #22d3ee;">
                            <i class="bi bi-clock-history me-2"></i> MIS COMPRAS ({{ $orders->total() }})
                        </h5>
                    </div>
...
<style>
    ...
    /* Forzar fondo oscuro en la tabla */
    .table,
    .table thead,
    .table tbody,
    .table tfoot,
